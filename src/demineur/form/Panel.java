...
public class Panel extends JPanel
{
	 ...
	 * 
	 */
	private Panel(int digits, Color displayColor, boolean paddingZeros)
	{
		super();
		...
		this.setPreferredSize(new Dimension(Panel.DIGIT_WIDTH * digits, Panel.HEIGHT));
	 ...
	 */
	public static Panel createLCDPanel(int digits)
	{
		Panel lcd = null;
		if (digits >= Panel.MINIMUM_DIGITS &&
				digits <= Panel.MAXIMUM_DIGITS)
		{
			lcd = new Panel(digits, Panel.DEFAULT_LCD_COLOR, true);
		}
		return lcd;
	}
	 ...
	 * @return
	 */
	public static Panel createLCDPanel(int digits, Color displayColor)
	{
		Panel lcd = null;
		if (digits >= Panel.MINIMUM_DIGITS &&
				digits <= Panel.MAXIMUM_DIGITS &&
		...
		{
			lcd = new Panel(digits, displayColor, true);
		}
		return lcd;
	}
	
	public static Panel createLCDPanel(int digits, Color displayColor, boolean paddingZeros)
	{
		Panel lcd = null;
		if (digits >= Panel.MINIMUM_DIGITS &&
				digits <= Panel.MAXIMUM_DIGITS &&
				!displayColor.equals(Color.BLACK))
		{
			lcd = new Panel(digits, displayColor, paddingZeros);
		}
		return lcd;
	}
	...
	private void drawDigit(int numDigit, Graphics g)
	{
		...
		int value = Panel.NO_DIGIT_VALUE;
		try
		{
		...
		if (value == 0)
		{
			...
			{
				for (int n : Panel.NUMS_CRISTAL_DIGIT_0)
				{
		...
		{
			for (int n : Panel.NUMS_CRISTAL_DIGITS[value])
			{
				this.drawCristal(n, numDigit, g);
			}
		}
	...
	private void drawLeftCristal(int numCristal, int numDigit, Graphics g)
	{
		...
		poly.addPoint(Panel.FIRST_CRISTAL_FIRST_X + Panel.DIGIT_WIDTH * numDigit, Panel.VERTICAL_CRISTAL_FIRST_Y + Panel.DIGIT_HEIGHT * numCristal);
		poly.addPoint(Panel.FIRST_CRISTAL_SECOND_X + Panel.DIGIT_WIDTH * numDigit, Panel.VERTICAL_CRISTAL_SECOND_Y + Panel.DIGIT_HEIGHT * numCristal);
		poly.addPoint(Panel.FIRST_CRISTAL_SECOND_X + Panel.DIGIT_WIDTH * numDigit, Panel.VERTICAL_CRISTAL_THIRD_Y + Panel.DIGIT_HEIGHT * numCristal);
		poly.addPoint(Panel.FIRST_CRISTAL_FIRST_X + Panel.DIGIT_WIDTH * numDigit, Panel.VERTICAL_CRISTAL_FOURTH_Y + Panel.DIGIT_HEIGHT * numCristal);
		g.fillPolygon(poly);
	}
	...
	{
		Polygon poly = new Polygon();
		poly.addPoint(3 + Panel.DIGIT_WIDTH * numDigit, 2);
		poly.addPoint(6 + Panel.DIGIT_WIDTH * numDigit, 6);
		poly.addPoint(13 + Panel.DIGIT_WIDTH * numDigit, 6);
		poly.addPoint(16 + Panel.DIGIT_WIDTH * numDigit, 2);
		g.fillPolygon(poly);
	}
	...
	{
		Polygon poly = new Polygon();
		poly.addPoint(3 + Panel.DIGIT_WIDTH * numDigit, Panel.MIDDLE_CRISTAL_SECOND_Y);
		poly.addPoint(7 + Panel.DIGIT_WIDTH * numDigit, Panel.MIDDLE_CRISTAL_FIRST_Y);
		poly.addPoint(13 + Panel.DIGIT_WIDTH * numDigit, Panel.MIDDLE_CRISTAL_FIRST_Y);
		poly.addPoint(17 + Panel.DIGIT_WIDTH * numDigit, Panel.MIDDLE_CRISTAL_SECOND_Y);
		poly.addPoint(13 + Panel.DIGIT_WIDTH * numDigit, Panel.MIDDLE_CRISTAL_THIRD_Y);
		poly.addPoint(7 + Panel.DIGIT_WIDTH * numDigit, Panel.MIDDLE_CRISTAL_THIRD_Y);
		g.fillPolygon(poly);
	}
	...
	{
		Polygon poly = new Polygon();
		poly.addPoint(3 + Panel.DIGIT_WIDTH * numDigit, Panel.LOWER_CRISTAL_SECOND_Y);
		poly.addPoint(6 + Panel.DIGIT_WIDTH * numDigit, Panel.LOWER_CRISTAL_FIRST_Y);
		poly.addPoint(14 + Panel.DIGIT_WIDTH * numDigit, Panel.LOWER_CRISTAL_FIRST_Y);
		poly.addPoint(17 + Panel.DIGIT_WIDTH * numDigit, Panel.LOWER_CRISTAL_SECOND_Y);
		g.fillPolygon(poly);
	}
	...
	private void drawRightCristal(int numCristal, int numDigit, Graphics g)
	{
		// Valeurs possibles pour numCristal : 0 et 1
		Polygon poly = new Polygon();
		poly.addPoint(Panel.SECOND_CRISTAL_SECOND_X + Panel.DIGIT_WIDTH * numDigit, Panel.VERTICAL_CRISTAL_FIRST_Y + Panel.DIGIT_HEIGHT * numCristal);
		poly.addPoint(Panel.SECOND_CRISTAL_FIRST_X + Panel.DIGIT_WIDTH * numDigit, Panel.VERTICAL_CRISTAL_SECOND_Y + Panel.DIGIT_HEIGHT * numCristal);
		poly.addPoint(Panel.SECOND_CRISTAL_FIRST_X + Panel.DIGIT_WIDTH * numDigit, Panel.VERTICAL_CRISTAL_THIRD_Y + Panel.DIGIT_HEIGHT * numCristal);
		poly.addPoint(Panel.SECOND_CRISTAL_SECOND_X + Panel.DIGIT_WIDTH * numDigit, Panel.VERTICAL_CRISTAL_FOURTH_Y + Panel.DIGIT_HEIGHT * numCristal);
		g.fillPolygon(poly);
	}
